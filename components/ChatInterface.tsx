...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ isOpen, onClose, isMobile }) => {
  ...
  const dataScienceProjects = [
    { id: 'nobel', name: 'Nobel Prizes Analysis', prompt: 'Tell me about your Nobel_Prizes_Analysis project analyzing Nobel laureates and Alfred Nobel\'s legacy. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
    { id: 'space', name: 'Space Missions Analysis', prompt: 'Tell me about your Space_Missions_Analysis project analyzing space race missions and launches since 1957. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
    { id: 'movie', name: 'Movie Budget Analysis', prompt: 'Tell me about your Movie_Budget_and_Financial_Records project analyzing film budgets and box office revenue. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
    { id: 'regression', name: 'Multivariable Regression', prompt: 'Tell me about your Multivariable_Regression_and_House_Valuation_Model project on Boston Housing Prices. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
    { id: 'handwashing', name: 'Handwashing Analysis', prompt: 'Tell me about your Handwashing_and_Deaths_at_Childbirth project analyzing Dr Semmelweis and Vienna General Hospital data. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
    { id: 'fatal', name: 'Fatal Force Analysis', prompt: 'Tell me about your Fatal_Force project. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
    { id: 'google-play', name: 'Google Play Store Analytics', prompt: 'Tell me about your Google_Play_Store_App_Analytics project. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
    { id: 'google-trends', name: 'Google Trends & Visualization', prompt: 'Tell me about your Google_Trends_and_Data_Visualisation project. Walk me through it end-to-end like I\'m a hiring manager. Include photos from the project and Panos\' markdown cells with his insights. You can use technical terms.' },
  ];
